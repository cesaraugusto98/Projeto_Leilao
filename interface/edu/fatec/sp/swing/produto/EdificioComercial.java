...
public class EdificioComercial extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					EdificioComercial frame = new EdificioComercial();
	...
	public EdificioComercial() {
		...
		JLabel txtArea = new JLabel("Area apto");
		...
		JLabel lblAreaApto = new JLabel("Area apto");
						...
						.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
							...
							.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
								...
								.addGroup(gl_panel.createSequentialGroup()
									...
									.addPreferredGap(ComponentPlacement.RELATED)
									.addComponent(textField_5, GroupLayout.PREFERRED_SIZE, 90, GroupLayout.PREFERRED_SIZE)
									.addPreferredGap(ComponentPlacement.UNRELATED)
									.addComponent(lblAreaApto)
									.addPreferredGap(ComponentPlacement.RELATED)
									.addComponent(txtCustoCondominio, GroupLayout.PREFERRED_SIZE, 90, GroupLayout.PREFERRED_SIZE)))
		...
		button.setBounds(158, 363, 117, 35);
		...
		button_1.setBounds(287, 363, 117, 35);
